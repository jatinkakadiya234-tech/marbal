    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-[#0E5543] to-[#1a7a5e] py-20 px-4 text-center">
        <div className="max-w-6xl mx-auto mt-10">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl text-[#F2E1C5]/90 mb-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-[#F2E1C5]">
            <div className="bg-[#F2E1C5]/10 backdrop-blur-md px-6 py-3 rounded-full">
              <span className="font-semibold">Luxury & Strength</span>
            </div>
            <div className="bg-[#F2E1C5]/10 backdrop-blur-md px-6 py-3 rounded-full">
              <span className="font-semibold">Decades of Excellence</span>
            </div>
            <div className="bg-[#F2E1C5]/10 backdrop-blur-md px-6 py-3 rounded-full">
              <span className="font-semibold">Riyadh • Jeddah • Dammam</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h3 className="text-lg sm:text-xl text-gray-600 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-800 mb-3 text-center">Choosing & Customization</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-800 mb-3 text-center">Precise Processing</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-800 mb-3 text-center">Quality Assurance</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-800 mb-3 text-center">Safe Packing & Shipping</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-800 mb-3 text-center">Prompt Delivery & Support</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <div className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {marbleVarieties.map((variety, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <h3 className="text-lg font-semibold text-[#0E5543] mb-3">
                  {variety.name}
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {variety.description}
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-700 italic max-w-4xl mx-auto">
