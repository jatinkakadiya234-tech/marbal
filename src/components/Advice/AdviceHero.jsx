        ...
        <>
            ...
            <section className="relative pt-16 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <HeaderContent
                        tagline=' PREMIUM CARE GUIDE'
                        title="Your Trusted Resource"
                        subtitle='Expert guidance to preserve the timeless elegance of your marble surfaces with premium care techniques.'
