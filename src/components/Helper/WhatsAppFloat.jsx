...
import { whatsappConfig, getWhatsAppUrl } from '../../config/whatsapp';
      ...
      <AnimatePresence>
        {isHovered && (
          ...
          >
            ...
            <div className={`absolute ${position.includes('left') ? 'left-0 transform -translate-x-1' : 'right-0 transform translate-x-1'} top-1/2 -translate-y-1/2 w-2 h-2 bg-gray-800 rotate-45`}></div>
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
