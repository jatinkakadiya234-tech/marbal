                ...
                >
                  ...
                  <div className="md:w-1/2 flex justify-center">
                    <div className="relative">
                      ...
                      <div
                        className={`w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 bg-white border-2 sm:border-3 md:border-4 flex items-center justify-center rounded-full shadow-lg transition-all duration-500  sm:rounded-full hover:scale-125 cursor-pointer ${
                          idx === activeIndex
