...
import { FiHeart, FiMenu, FiSearch, FiX, FiShoppingCart } from 'react-icons/fi';
    ...
    <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-[#0E5543] backdrop-blur-md shadow-xl py-1' : 'bg-gradient-to-b from-gray-900 to-gray-850 py-2 border-b border-gray-700/30'}`}>
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="inline-flex items-center">
              <img src={logo} alt="RGM" className="h-12 md:h-12 w-auto object-contain" style={{borderRadius:"30%"}}/>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            ...
            <div className="flex items-center ml-4 pl-4 border-l border-gray-700 space-x-4">
              ...
              <Link to="/cart" className="relative p-2 text-white hover:text-amber-300 transition-colors duration-300">
          ...
          <div className="md:hidden flex items-center space-x-4">
            <Link to="/cart" className="relative p-2 text-[#F2E1C5]">
      ...
      >
        ...
        <div className="px-2 pt-2 pb-6 space-y-2 sm:px-4 overflow-y-auto h-[calc(100%-4rem)]">
          ...
          <Link
            to="/OurStones"
            className={`block px-4 py-3 rounded-xl transition-all duration-300 flex items-center group ${activeItem === 'Our Stones' ? 'bg-[#F2E1C5]/10 text-[#F2E1C5]' : 'text-[#F2E1C5] hover:bg-[#F2E1C5]/50 hover:text-[#F2E1C5]'}`}
            onClick={() => handleItemClick('Our Stones')}
          >
            <span className="font-medium">Our Stones</span>
          </Link>
          <Link
            to="/Services"
          ...
          <div className="pt-3 mt-3 border-t border-gray-800">
            ...
            <Link to="/cart" className="block px-4 py-3 text-gray-300 hover:bg-gray-800/50 hover:text-amber-300 rounded-xl transition-all duration-300 flex items-center group">
